...
public class CodePushUpdateManager {
    ...
    public JSONObject getCurrentPackageInfo() {
        ...
        try {
            ...
            JSONObject jsonObject = CodePushUtils.getJsonObjectFromFile(statusFilePath);

//            if(jsonObject.has(mType)) {
//                return jsonObject.getJSONObject(mType);
//            }
...
//            throw new RuntimeException("Unable to get object", e);
//        }
    }
